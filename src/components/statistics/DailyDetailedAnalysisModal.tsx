                    ...
                    <div className="relative">
                        ...
                        <div className="relative mt-16 mb-8 px-1">
                            {(() => {
                                ...
                                const firstStart = new Date(sortedSessions[0].startTime).getTime();
                                const lastEnd = new Date(sortedSessions[sortedSessions.length - 1].endTime).getTime();
                                                            ...
                                                            (session.timeline as unknown as TimelineEvent[]).map((event, eIdx, arr) => {
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 px-2 py-1 bg-black/90 backdrop-blur-md rounded-lg text-[10px] font-bold text-white opacity-0 group-hover/segment:opacity-100 transition-all pointer-events-none whitespace-nowrap border border-white/10 z-50 shadow-xl">
