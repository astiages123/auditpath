...
import { Achievement, getRequirementDescription, GUILDS } from "@/lib/achievements";
        ...
        >
            ...
            <div className="relative w-28 h-28 mb-3">
                <img
                    ...
                    className={`object-contain transition-all duration-300 w-full h-full ${isUnlocked
                        ? "seal-unlocked seal-glow"
                        : "seal-locked"
                        }`}
                />
            ...
            {/* Title */}
            <h3
                className={`text-sm font-semibold text-center transition-colors ${isUnlocked ? "text-foreground" : "text-muted-foreground"
                    }`}
