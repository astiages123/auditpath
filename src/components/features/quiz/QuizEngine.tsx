...
import { checkAndTriggerBackgroundGeneration } from '@/lib/ai/background-generator';
import { QuizTimer } from './QuizTimer';
import { useAuth } from '@/hooks/useAuth';
import { PostTestDashboard } from './PostTestDashboard';
import { finishQuizSession } from '@/lib/client-db';
import { calculateTestResults } from '@/lib/utils/testResultCalculator';
