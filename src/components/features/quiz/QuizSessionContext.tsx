...
import { SessionInfo, QuotaInfo, ReviewItem } from '@/lib/srs';
import { QuizResponseType } from '@/lib/srs/srs-algorithm';
...
export interface QuizSessionState {
  ...
  courseStats: import('@/lib/srs/stats').CourseStats | null;
}
