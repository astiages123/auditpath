...
import {
  ...
  getFocusPowerData,
  getLearningLoadData,
} from '@/features/statistics/services/statisticsDataService';
import type { LearningLoad } from '@/features/statistics/types/statisticsTypes';
import { getVirtualDateKey } from '@/utils/dateUtils';
import * as statisticsHelpers from '@/features/statistics/logic/statisticsHelpers';
...
describe('statisticsDataService - Day Filtering Logic', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
