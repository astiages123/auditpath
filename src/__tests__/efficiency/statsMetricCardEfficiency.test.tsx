...
// Bileşenler
import { StatsMetricCard } from '@/features/efficiency/components/cards/StatsMetricCard';
import {
  StatCard as DashStatCard,
  TrendBadge,
} from '@/features/efficiency/components/shared/CardElements';
import { MasteryProgressNavigator } from '@/features/efficiency/components/content/MasteryProgressNavigator';
...
vi.mock('@/features/efficiency/components/shared/GoalProgressRing', () => ({
  GoalProgressRing: () => <div data-testid="goal-ring-mock" />,
}));

vi.mock('@/features/efficiency/components/content/FocusStreamHub', () => ({
  FocusStreamHub: () => <div data-testid="focus-stream-mock" />,
}));

vi.mock(
  '@/features/efficiency/components/shared/CardElements',
  async (importOriginal) => {
    const actual =
      await importOriginal<
        typeof import('@/features/efficiency/components/shared/CardElements')
      >();
    return {
      ...actual,
