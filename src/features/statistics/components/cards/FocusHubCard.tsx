...
import { TrendBadge } from '@/features/statistics/components/shared/CardElements';
import { StatisticsModal } from '@/features/statistics/components/modals/StatisticsModal';
import { FocusStreamHub as FocusHubContent } from '@/features/statistics/components/content/FocusStreamHub';
import { GoalProgressRing } from '@/features/statistics/components/shared/GoalProgressRing';
import {
  getFlowColor,
  getFlowStatusLabel,
} from '@/features/statistics/logic/flowStateConfig';
...
export const FocusHubCard = ({
  ...
  const logic = useStatisticsLogic({
