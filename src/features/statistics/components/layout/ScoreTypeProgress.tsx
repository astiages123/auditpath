...
import { calculateScoreTypeProgress } from '@/features/statistics/logic/scoreCalculations';
...
const ScoreTypeRadarModal = lazy(() =>
  import('@/features/statistics/components/modals/ScoreTypeRadarModal').then(
    (module) => ({
