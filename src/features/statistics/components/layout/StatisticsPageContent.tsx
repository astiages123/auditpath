...
const StatisticsDashboard = () => {
  ...
  const masteries = lessonMastery.map((mastery) => ({
    courseId: mastery.lessonId,
    courseName: mastery.title,
    courseType: mastery.type,
    videoProgress: mastery.videoProgress,
    questionProgress: mastery.questionProgress,
    masteryScore: mastery.mastery,
  }));
              ...
              cognitiveAnalysis
                ? {
                    ...
                    recentInsights: cognitiveAnalysis.recentInsights?.filter(
                      (insight): insight is string => insight !== null
                    ),
                    criticalTopics: cognitiveAnalysis.criticalTopics?.map(
                      (topic: {
                        ...
                        ...topic,
                        diagnosis: topic.diagnosis || undefined,
                      })
                    ),
                  }
                : null
