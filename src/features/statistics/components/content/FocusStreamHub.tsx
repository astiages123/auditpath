...
import { DistractionDetails } from '@/features/statistics/components/content/DistractionDetails';
...
const StatisticsTrendChart = lazy(() =>
  import('@/features/statistics/components/charts/StatisticsTrendChart').then(
    (m) => ({
      default: m.StatisticsTrendChart,
    })
  )
);
        ...
        <div className="space-y-4">
          ...
          {isHistoryEmpty ? (
            ...
            <Suspense fallback={<ChartFallback />}>
              <StatisticsTrendChart data={trendData} />
            </Suspense>
          )}
        </div>
      </TabsContent>
