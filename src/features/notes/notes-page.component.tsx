...
import { getCourseTopics, getCourseIdBySlug } from '@/services/client-db';
...
// New Components
import { MarkdownSection } from './markdown-section.component';
import { markdownComponents } from './markdown-components.component';
import { GlobalNavigation } from './global-navigation.component';
import { LocalToC } from './local-to-c.component';

// New Hooks
import { useNotesNavigation } from './notes-navigation.hook';
import { useTableOfContents } from './table-of-contents.hook';
