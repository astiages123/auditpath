...
import { getUnlockedAchievements as getDbUnlocked } from '@/services/client-db';
...
import { SealCard } from './seal-card.component';
import { SealDetailModal } from './seal-detail-modal.component';
