...
import { LearningLoadAnalysis as LearningLoadContent } from '@/features/efficiency/components/content/LearningLoadAnalysis';
...
const LearningLoadChart = lazy(
  () => import('@/features/efficiency/components/charts/LearningLoadChart')
);
