...
export const LearningLoadCard = () => {
  const { loading, loadWeek, loadDay, loadMonth, loadAll, dailyGoalMinutes } = useEfficiencyData();
        ...
        <div className="h-full w-full cursor-pointer">
          <GlassCard className="h-full flex flex-col p-6">
            ...
            <div className="flex-1 w-full min-h-0 mt-4">
              <LearningLoadChart data={loadWeek} targetMinutes={dailyGoalMinutes || 200} />
            </div>
          </GlassCard>
        </div>
      }
