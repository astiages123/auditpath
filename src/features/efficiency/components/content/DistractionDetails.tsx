...
import { AlertCircle, Clock, ZapOff, TrendingDown, Timer } from 'lucide-react';
...
import type { Session } from '@/features/efficiency/types/efficiencyTypes';
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {allPauses.length > 0 ? (
          ...
          <CommonEmptyState
            message="Bugün henüz bir duraklatma kaydedilmedi."
            className="border border-dashed border-white/5 bg-white/2 rounded-2xl"
          />
        )}
      </div>
    </div>
