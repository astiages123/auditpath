...
import { FocusPowerTrendChart } from "./EfficiencyCharts";
    ...
    const TriggerContent = (
        ...
        >
            ...
            <div className="flex items-center gap-4">
                ...
                {!disableModal && <ChevronRight className="w-5 h-5 text-muted-foreground/40 group-hover:text-white/60 transition-colors" />}
            </div>
        </div>
    );
    ...
    return (
        <div className="space-y-4 bg-white/5 rounded-xl p-4 border border-white/5">
            <div className="flex items-center justify-between">
                <div>
                   <h4 className="text-sm font-bold text-white uppercase tracking-wider">Odak Gücü Trendi</h4>
                    <span className="text-xs text-muted-foreground">{getLabel()} Performansı</span>
                </div>
                <div className="flex bg-black/20 p-1 rounded-lg border border-white/5">
                    <button 
                        ...
                        className={cn(
                            ...
                            range === "week" ? "bg-white/10 text-white shadow-sm" : "text-muted-foreground hover:text-white/80"
                        )}
                    >
                        Hafta
                    </button>
                    <button 
                         ...
                         className={cn(
                            "px-3 py-1 text-xs font-medium rounded-md transition-all",
                            range === "month" ? "bg-white/10 text-white shadow-sm" : "text-muted-foreground hover:text-white/80"
                        )}
                    >
                        Ay
                    </button>
                    <button 
                         ...
                         className={cn(
                            "px-3 py-1 text-xs font-medium rounded-md transition-all",
                            range === "all" ? "bg-white/10 text-white shadow-sm" : "text-muted-foreground hover:text-white/80"
                        )}
                    >
                        Tümü
                    </button>
    ...
    return (
        ...
        >
            <Tabs defaultValue="list" className="w-full">
                ...
                <TabsContent value="list" className="space-y-2 max-h-[70vh] overflow-y-auto custom-scrollbar p-1">
