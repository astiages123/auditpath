...
import { Home, Clock, CheckCircle2, HelpCircle } from 'lucide-react';
import { TestResultSummary } from '@/features/quiz/tasks/solve-quiz/internals/test-result-calculator';
...
export function PostTestDashboard({ results, onClose }: PostTestDashboardProps) {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto space-y-8 p-6">
            ...
            >
                ...
                <div className="space-y-3 text-sm text-balance leading-relaxed text-muted-foreground">
