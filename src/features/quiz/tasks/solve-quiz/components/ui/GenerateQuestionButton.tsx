...
import { getChunkQuotaStatus, type QuotaStatus, generateQuestionsForChunk, type GenerationLog, type LogStep } from '@/features/quiz';
      ...
      await generateQuestionsForChunk(chunkId, {
        onLog: (log: GenerationLog) => {
          ...
          if (log.step === 'MAPPING' && log.details?.conceptCount) {
             setStatus(prev => prev ? { 
                ...prev, 
                conceptCount: Number(log.details.conceptCount) || prev.conceptCount 
             } : prev);
          }
        },
          ...
          <div className="py-4 space-y-4 flex-1 overflow-hidden flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-xl bg-muted/50 p-6 flex flex-col items-center justify-center gap-2 border border-border/50">
                ...
                <span className="text-muted-foreground text-sm font-medium">Anlamlı Kelime</span>
