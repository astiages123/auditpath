...
import { UnifiedLLMClient } from "@/features/quiz/quiz.client";
import { rateLimiter } from "@/features/quiz/quiz-rate-limit";
import { COMMON_OUTPUT_FORMATS, GENERAL_QUALITY_RULES } from "./quiz-prompts";
...
export class DebugLogger {
  ...
  static group(name: string, data?: Record<string, unknown>) {
    ...
    const hasGroupCollapsed = typeof console !== "undefined" &&
