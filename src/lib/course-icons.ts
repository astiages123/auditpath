import { LucideIcon, BookOpen, TrendingUp, BarChart3, Gavel, Calculator, PiggyBank, Globe, Languages, Scale, Briefcase, FileText } from "lucide-react";
...
export function getCourseIcon(courseName: string | null): LucideIcon {
  ...
  if (name.includes("hukuk") || name.includes("anayasa") || name.includes("ceza")) return Gavel;
...
export function getCourseColor(courseName: string | null): string {
  ...
  if (name.includes("mikro") || name.includes("makro") || name.includes("iktisat")) return "bg-emerald-500/20";
  if (name.includes("hukuk") || name.includes("anayasa") || name.includes("ceza")) return "bg-amber-500/20";
  if (name.includes("muhasebe")) return "bg-blue-500/20";
  if (name.includes("maliye") || name.includes("vergi")) return "bg-purple-500/20";
  if (name.includes("ingilizce") || name.includes("english") || name.includes("dil")) return "bg-rose-500/20";
...
export function getCourseIconColor(courseName: string | null): string {
  ...
  if (name.includes("mikro") || name.includes("makro") || name.includes("iktisat")) return "text-emerald-500";
  if (name.includes("hukuk") || name.includes("anayasa") || name.includes("ceza")) return "text-amber-500";
  if (name.includes("muhasebe")) return "text-blue-500";
  if (name.includes("maliye") || name.includes("vergi")) return "text-purple-500";
  if (name.includes("ingilizce") || name.includes("english") || name.includes("dil")) return "text-rose-500";
