    ...
    if (isOpen) {
      ...
      const interval = setInterval(function () {
        ...
        confetti({
          ...
          colors: variant === "rank" ? ["#fbbf24", "#f59e0b", "#d97706"] : undefined,
        });
        confetti({
          ...defaults,
          particleCount,
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md border-none bg-transparent shadow-none p-0 overflow-hidden outline-hidden [&>button]:hidden">
        ...
        <DialogDescription className="sr-only">{subtitle || description}</DialogDescription>
                ...
                <div className="flex flex-col items-center gap-6 relative z-10 w-full">
                  ...
                  {imageUrl ? (
                    ...
                    <motion.div
                      ...
                      className={cn(
                        "relative group",
                        variant === "rank" ? "text-amber-400" : "text-blue-400"
                      )}
                    >
                      {/* Ornate Frame */}
                      <div className={cn(
                  ...
                  <div className="space-y-6 w-full text-center">
                    ...
                    <motion.p 
                      ...
                      className={cn(
                        ...
                        variant === "rank" ? "text-amber-500/80" : "text-blue-300/80",
                        "mb-1"
                      )}
                    >
                      {title}
                      ...
                      >
                         ...
                         <p className={cn(
                           "text-base font-medium italic font-sans max-w-[280px] mx-auto leading-relaxed",
                            variant === "rank" ? "text-amber-200/80" : "text-amber-500"
                         )}>
                    ...
                    {/* 3. Big Description (Middle) - The Main Name */}
                     <motion.div 
                        ...
                        className={cn(
                          ...
                          variant === "rank" ? "text-amber-100" : "text-foreground/90"
                        )} 
                        style={{ 
                          textShadow: variant === "rank" ? "0 0 30px rgba(251,191,36,0.4)" : "0 0 30px rgba(59,130,246,0.4)" 
                        }}
                     >
                        {description}
                     </motion.div>
