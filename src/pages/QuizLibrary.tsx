      ...
      <div className="p-5 md:p-8 space-y-4 md:space-y-6">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-base md:text-xl font-black leading-tight group-hover:text-primary line-clamp-2 transition-colors">
              {course.name}
            </h3>
          </div>
          <div
            className={`shrink-0 flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full border ${
              isActive
