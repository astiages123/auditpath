1. Sözel Mantık
1. Değişkenlerin sayısal dağılım dengesini ve kısıtların matematiksel sağlamasını temel alan bir kurgu oluştur.
...
2. Finansal Yönetim
1. Finansal analiz tekniklerini ve maliyet hesaplamalarını, stratejik işletme kararlarıyla ve nakit akışıyla bütüncül şekilde ilişkilendir.
...
3. Muhasebe
1. Münferit yevmiye kayıtları yerine, işlemlerin mali tabloların bütününe ve öz kaynak yapısına olan etkisini sorgulayan kurgular yap.
...
4. Maliye
1. Kamu gelirleri ve harcamalarının ekonomik etkilerini, piyasa dengesi ve arz/talep esneklik kavramlarıyla ilişkilendirerek kurgula.
...
1. Yargılama hukukunun usul kurallarını, hak düşürücü süreleri ve usul ekonomisi ilkesini merkeze alan teknik kurgular yap.
...
6. Banka Muhasebesi
1. Bankacılığın kendine özgü bilanço yapısını (mevduat-pasif, kredi-aktif ilişkisi) ve bu yapının operasyonel yansımalarını temel alan kurgular oluştur.
...
1. Uluslararası uzmanlaşma teorilerini, alternatif maliyetler ve üretim avantajları üzerinden stratejik karar verme süreçleriyle ilişkilendirerek test et.
...
8. İngilizce
1. Kelime bilgisini bağlamsal birliktelikler (collocations) odaklı, dil bilgisini ise iletişimsel ve işlevsel kullanım yetkinliği üzerinden ölçen kurgular oluştur.
...
9. Borçlar Hukuku
1. Sözleşme özgürlüğünün sınırları, irade sakatlıkları ve yetkisiz temsil gibi borç ilişkisinin doğumundaki kritik süreçlere ve kurucu unsurlara odaklan.
...
10. İşletme Yönetimi
1. Yönetim fonksiyonlarını ve organizasyonel yapılanma modellerini, tanımlardan ziyade somut yönetici davranışları ve karar alma süreçleri üzerinden sorgula.
...
 
11. Ceza Hukuku
1. Soyut tanımlardan kaçınarak; suçun maddi ve manevi unsurları ile illiyet bağını irdeleyen somut olay (vaka) analizleri kurgula.
...
1. Ekonomi tarihindeki temel dönüşüm evrelerini ve bu dönemlerde uygulanan kalkınma/sanayileşme stratejilerini mukayeseli şekilde test et.
...
1. Paranın zaman değeri kavramını; farklı faiz türleri, ödeme planları ve taksitli nakit akışı senaryoları üzerinden bütüncül şekilde test et.
...
14. Mikro İktisat
1. Analitik düşünmeyi zorlayan değişken etkileşimlerini ve piyasa dengesi değişimlerini (fiyat ve miktar etkileri) temel alan kurgular yap.
...
15. İstatistik
1. Salt işlem yerine; veri setindeki değişimlerin ve manipülasyonların merkezi eğilim ve yayılım ölçüleri üzerindeki istatistiksel etkisini sorgula.
...
16. Medeni Hukuk
1. Hak ve fiil ehliyeti, kısıtlılık halleri ve vesayet rejimini içeren somut hayat olayları (vaka) üzerinden hukuki muhakeme yaptır.
...
1. Bankacılık Kanunu kapsamındaki denetim ve gözetim mekanizmalarını, düzenleyici kurumların yetki alanlarını ve müdahale süreçlerini temel al.
...
1. Stratejik pazarlama modellerini ve analiz araçlarını, salt teorik bilgi yerine somut pazar senaryoları ve işletme kararlarıyla birleştirerek test et.
...
1. Merkez bankası politika araçlarının ve para politikası kanallarının piyasa likiditesi ile reel ekonomi üzerindeki etkileşimini test et.
...
1. İcra ve iflas hukukunun şekli yapısına bağlı kalarak; takip yolları, itiraz süreçleri ve hak düşürücü süreleri vaka analizleri üzerinden sorgula.
...
21. Matematik
1. İşlemsel çözümleme yerine, problem senaryolarını matematiksel modellere dönüştürme ve denklem kurma becerilerini test et.
...
22. İş Hukuku
1. İş Kanunu ekseninde; feshin hukuki niteliği, geçerlilik şartları ve usulüne uygunluk süreçlerini içeren somut vaka analizleri kurgula.
...
23. Makro İktisat
1. Ekonomik denge mekanizmalarını ve piyasa etkileşimlerini, temel makroekonomik modeller üzerinden analitik bir derinlikle sorgula.
...
24. Ticaret Hukuku
1. Ticari işletme, şirketler ve kıymetli evrak hukuku disiplinlerinde; soyut hükümler yerine somut olaylara dayalı hukuki uyuşmazlıklar kurgula.
